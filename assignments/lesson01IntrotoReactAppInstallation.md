...
screen capture of the newly installed project directory
...
screen capture of app title in browser
...
screen capture of the todos in browser

Instructions Part 4: Final Steps
Update the Project's README
Note

Write in with whatever language you are most comfortable. We suggest you also use markdown for any formatting - it's a simple document markup syntax that can be learned very quickly.
